...
export const FloatingNav = ({
  ...
  useMotionValueEvent(scrollYProgress, "change", (current) => {
    if (typeof current === "number") {
      const direction = current - scrollYProgress.getPrevious()!; // Use const instead of let
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <button className="border text-sm font-medium relative border-white/[0.2] text-white px-4 py-2 rounded-full" style={{ fontFamily: 'Poppins, sans-serif' }}>
          <span>Hire Me</span>
